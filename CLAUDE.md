...
Source lives in `src/` (auth, infra, universe, filing_fetcher, extraction_v2, review, shared, web, llm, gold_standard, ml). Config in `config/metric_keywords.yaml`. See `docs/README.md` for full index.
