...
| #85 | review | M | `src/extraction_v2/pipeline.py` `src/extraction_v2/stages/image_triage.py` `src/extraction_v2/stages/ocr_extraction.py` `data/gold_standard/v2_baseline.json` | Root cause likely in PR |
...
## #85. Text Recall Regression on Farfetch + Robinhood Between 04-19 and 04-22 Baselines
