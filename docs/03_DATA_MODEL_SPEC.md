...
- `alignment_flag` (`text`, nullable) – Alignment classification for this specific value vs canonical definition: `aligned`, `partial`, `not_aligned`, `unknown`.
...
- `quality_overall_score` (`integer`, nullable) – 0–3 overall quality score (see QA doc)  
