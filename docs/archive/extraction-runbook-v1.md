# Extraction Operations Runbook (V1 — Archived)

> **Archived:** 2026-03-12
> **Reason:** V1 extraction pipeline (`src/extraction/`) was removed in v2.7. All procedures in this document reference deleted scripts (`reextract_all_filings.py`, `debug_segmentation.py`, `generate_review_candidates.py`) and the deleted `src/extraction/html_segmenter.py` module. For V2 operations, see [`docs/operations/extraction-runbook.md`](extraction-runbook.md) and [`docs/operations/v2-deployment-guide.md`](v2-deployment-guide.md).

**Last Updated:** 2024-12-24 (archived 2026-03-12)
