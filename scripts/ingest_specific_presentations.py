...
def _upsert_presentation_filing(
    ...
    # Derive cik + sec_html_url from source_id so the review UI can link to
    # the filing. Mirrors scripts/ingest_presentations.py — see Issue #26.
    from scripts.ingest_presentations import _derive_presentation_urls
