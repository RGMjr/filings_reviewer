        ...
        try:
            ...
            for segment in table_segments:
                try:
                    ...
                    if (
                        len(rows) > context.config.max_table_rows
                        or cols > context.config.max_table_cols
                    ):
                        warnings.append(
                    ...
                    error_msg = (
                        f"Failed to reconstruct table from segment {segment.segment_id}: {e}"
                    )
            ...
            raise V2FatalError(str(e), stage_name="table_reconstruction") from e
