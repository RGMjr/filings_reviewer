    ...
    def process(self, context: PipelineContext) -> StageResult:
        ...
        try:
            ...
            for metric_id in metric_ids:
                ...
                # Assess alignment
                alignment_flag = self._assess_alignment(
                ...
                md = MetricDefinition(
                    ...
                    definition_segment_id=definition_segments[0].segment_id
                    if definition_segments
                    else None,
                    methodology_segment_id=methodology_segments[0].segment_id
            ...
            raise V2FatalError(str(e), stage_name="definition_extraction") from e
