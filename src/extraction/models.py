...
class MetricValue:
    ...
    period_type: Optional[str] = None  # 'fy', 'quarter', 'month', 'ttm', 'since_inception'
    ...
    segment_dimension: Optional[str] = None  # e.g., 'customer_type', 'product', 'geography'
    segment_value: Optional[str] = None  # e.g., 'enterprise', 'SMB', 'US'

    # Quality / alignment
    qa_status: str = 'unreviewed'  # 'unreviewed', 'pass', 'warning', 'fail'
    qa_notes: Optional[str] = None
    alignment_flag: Optional[str] = None  # 'aligned', 'partial', 'not_aligned', 'unknown'
