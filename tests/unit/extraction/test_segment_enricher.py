...
class TestEnrichBatch:
    ...
    def test_enrich_batch_multiple_segments(self, enricher: SegmentEnricher) -> None:
...
class TestMetricDensity:
    ...
    def test_metric_density_basic_calculation(self, enricher: SegmentEnricher) -> None:
    ...
    def test_metric_density_with_duplicates(self, enricher: SegmentEnricher) -> None:
    ...
    def test_metric_density_empty_text(self, enricher: SegmentEnricher) -> None:
        """Empty raw_text -> 0.0."""
        segment = SourceSegment(
            filing_id=1,
            segment_type="paragraph",
    ...
    def test_metric_density_no_metrics(self, enricher: SegmentEnricher) -> None:
    ...
    def test_metric_density_rounding(self, enricher: SegmentEnricher) -> None:
    ...
    def test_metric_density_high_value(self, enricher: SegmentEnricher) -> None:
...
class TestDistinctMetricCount:
    ...
    def test_distinct_count_unique_ids(self, enricher: SegmentEnricher) -> None:
    ...
    def test_distinct_count_with_duplicates(self, enricher: SegmentEnricher) -> None:
    ...
    def test_distinct_count_none_list(self, enricher: SegmentEnricher) -> None:
...
class TestEdgeCases:
    ...
    def test_segment_with_all_none_values(self, enricher: SegmentEnricher) -> None:
    ...
    def test_segment_with_whitespace_only_text(self, enricher: SegmentEnricher) -> None:
        """raw_text = '   ' (whitespace)."""
        segment = SourceSegment(
            filing_id=1,
            segment_type="paragraph",
    ...
    def test_preserves_other_fields(self, enricher: SegmentEnricher) -> None:
    ...
    def test_segment_with_single_character_text(self, enricher: SegmentEnricher) -> None:
    ...
    def test_exception_during_enrichment_is_caught(self, enricher: SegmentEnricher) -> None:
        ...
        with patch.object(enricher, "_enrich_segment", side_effect=ValueError("Test error")):
...
class TestTemporalTrendDetection:
    ...
    def test_single_year_returns_false(self, enricher: SegmentEnricher) -> None:
    ...
    def test_two_distinct_years_returns_true(self, enricher: SegmentEnricher) -> None:
    ...
    def test_three_distinct_years_returns_true(self, enricher: SegmentEnricher) -> None:
    ...
    def test_same_year_repeated_returns_false(self, enricher: SegmentEnricher) -> None:
    ...
    def test_years_at_boundaries(self, enricher: SegmentEnricher) -> None:
    ...
    def test_fiscal_year_references_returns_true(self, enricher: SegmentEnricher) -> None:
    ...
    def test_quarter_references_returns_true(self, enricher: SegmentEnricher) -> None:
    ...
    def test_single_fiscal_period_returns_false(self, enricher: SegmentEnricher) -> None:
    ...
    def test_year_over_year_with_single_year_returns_true(self, enricher: SegmentEnricher) -> None:
    ...
    def test_yoy_standalone_returns_true(self, enricher: SegmentEnricher) -> None:
    ...
    def test_yoy_in_other_words_returns_false(self, enricher: SegmentEnricher) -> None:
    ...
    def test_compared_to_prior_year_returns_true(self, enricher: SegmentEnricher) -> None:
    ...
    def test_none_raw_text_returns_false(self, enricher: SegmentEnricher) -> None:
        """None raw_text -> False."""
        segment = SourceSegment(
            filing_id=1,
            segment_type="paragraph",
    ...
    def test_no_temporal_language_returns_false(self, enricher: SegmentEnricher) -> None:
    ...
    def test_year_embedded_in_number_not_matched(self, enricher: SegmentEnricher) -> None:
    ...
    def test_non_string_raw_text_returns_false(self, enricher: SegmentEnricher) -> None:
    ...
    def test_full_enrich_batch_sets_temporal_trend(self, enricher: SegmentEnricher) -> None:
    ...
    def test_temporal_trend_alongside_density_calculation(self, enricher: SegmentEnricher) -> None:
...
class TestCohortBreakdownDetection:
    ...
    def test_percentage_of_consumers_new_customers(self, enricher: SegmentEnricher) -> None:
    ...
    def test_percentage_of_users_enterprise(self, enricher: SegmentEnricher) -> None:
    ...
    def test_percentage_revenue_growth_no_customer_context(self, enricher: SegmentEnricher) -> None:
    ...
    def test_percentage_satisfaction_rate(self, enricher: SegmentEnricher) -> None:
    ...
    def test_cohort_analysis_keyword(self, enricher: SegmentEnricher) -> None:
    ...
    def test_customers_acquired_in_year(self, enricher: SegmentEnricher) -> None:
    ...
    def test_by_tenure_cohort(self, enricher: SegmentEnricher) -> None:
    ...
    def test_customer_lifetime_value(self, enricher: SegmentEnricher) -> None:
    ...
    def test_cohesive_not_cohort(self, enricher: SegmentEnricher) -> None:
    ...
    def test_new_customers_represented_percentage(self, enricher: SegmentEnricher) -> None:
    ...
    def test_existing_vs_new_customers(self, enricher: SegmentEnricher) -> None:
    ...
    def test_first_year_customers(self, enricher: SegmentEnricher) -> None:
    ...
    def test_multiple_cohort_metrics_returns_true(self, enricher: SegmentEnricher) -> None:
    ...
    def test_single_non_cohort_metric_returns_false(self, enricher: SegmentEnricher) -> None:
    ...
    def test_case_insensitive_detection(self, enricher: SegmentEnricher) -> None:
    ...
    def test_full_enrich_batch_sets_cohort_breakdown(self, enricher: SegmentEnricher) -> None:
    ...
    def test_cohort_alongside_temporal_and_density(self, enricher: SegmentEnricher) -> None:
...
class TestImageDetection:
    ...
    def test_single_large_image_returns_1(self, enricher: SegmentEnricher) -> None:
    ...
    def test_svg_chart_returns_1(self, enricher: SegmentEnricher) -> None:
    ...
    def test_canvas_element_returns_1(self, enricher: SegmentEnricher) -> None:
    ...
    def test_small_width_filtered_out(self, enricher: SegmentEnricher) -> None:
    ...
    def test_small_height_filtered_out(self, enricher: SegmentEnricher) -> None:
    ...
    def test_icon_class_filtered_out(self, enricher: SegmentEnricher) -> None:
    ...
    def test_logo_alt_filtered_out(self, enricher: SegmentEnricher) -> None:
    ...
    def test_bullet_arrow_spacer_filtered_out(self, enricher: SegmentEnricher) -> None:
    ...
    def test_chart_image_plus_logo_only_chart_counted(self, enricher: SegmentEnricher) -> None:
    ...
    def test_none_raw_html_returns_0(self, enricher: SegmentEnricher) -> None:
        """None raw_html -> 0."""
        segment = SourceSegment(
            filing_id=1,
            segment_type="paragraph",
    ...
    def test_empty_raw_html_returns_0(self, enricher: SegmentEnricher) -> None:
    ...
    def test_image_without_dimensions_counted(self, enricher: SegmentEnricher) -> None:
    ...
    def test_width_with_px_suffix_parsed_correctly(self, enricher: SegmentEnricher) -> None:
    ...
    def test_percentage_width_not_filtered(self, enricher: SegmentEnricher) -> None:
    ...
    def test_mixed_case_keywords_detected(self, enricher: SegmentEnricher) -> None:
    ...
    def test_inline_svg_counted(self, enricher: SegmentEnricher) -> None:
    ...
    def test_multiple_decorative_keywords_filtered(self, enricher: SegmentEnricher) -> None:
    ...
    def test_full_enrich_batch_sets_image_count(self, enricher: SegmentEnricher) -> None:
    ...
    def test_image_count_alongside_density_temporal_cohort(self, enricher: SegmentEnricher) -> None:
...
class TestParseDimension:
    ...
    def test_parse_integer_string(self, enricher: SegmentEnricher) -> None:
        """'100' -> 100."""
        result = enricher._parse_dimension("100")
        assert result == 100

    def test_parse_px_suffix(self, enricher: SegmentEnricher) -> None:
        """'100px' -> 100."""
        result = enricher._parse_dimension("100px")
        assert result == 100

    def test_parse_percentage_returns_none(self, enricher: SegmentEnricher) -> None:
        """'100%' -> None (not a pixel count)."""
        result = enricher._parse_dimension("100%")
        assert result is None

    def test_parse_empty_returns_none(self, enricher: SegmentEnricher) -> None:
        """'' -> None."""
        result = enricher._parse_dimension("")
        assert result is None

    def test_parse_none_returns_none(self, enricher: SegmentEnricher) -> None:
        """None -> None."""
        result = enricher._parse_dimension(None)
        assert result is None

    def test_parse_whitespace_with_px(self, enricher: SegmentEnricher) -> None:
        """' 100px ' -> 100 (whitespace handled)."""
        result = enricher._parse_dimension(" 100px ")
        assert result == 100

    def test_parse_non_numeric_returns_none(self, enricher: SegmentEnricher) -> None:
        """'auto' -> None."""
        result = enricher._parse_dimension("auto")
        assert result is None

    def test_parse_integer_type_converted(self, enricher: SegmentEnricher) -> None:
...
class TestIsDecorativeImage:
    ...
    def test_image_with_class_as_string(self, enricher: SegmentEnricher) -> None:
    ...
    def test_image_with_none_alt(self, enricher: SegmentEnricher) -> None:
...
class TestDetectImagesErrorHandling:
    ...
    def test_malformed_html_returns_0(self, enricher: SegmentEnricher) -> None:
...
class TestRichnessScore:
    ...
    def test_base_confidence_zero(self, enricher: SegmentEnricher) -> None:
    ...
    def test_base_confidence_half(self, enricher: SegmentEnricher) -> None:
    ...
    def test_base_confidence_full(self, enricher: SegmentEnricher) -> None:
    ...
    def test_base_confidence_none(self, enricher: SegmentEnricher) -> None:
    ...
    def test_metric_density_zero_metrics(self, enricher: SegmentEnricher) -> None:
    ...
    def test_metric_density_one_metric(self, enricher: SegmentEnricher) -> None:
    ...
    def test_metric_density_four_metrics_capped(self, enricher: SegmentEnricher) -> None:
    ...
    def test_metric_density_ten_metrics_capped(self, enricher: SegmentEnricher) -> None:
        """10 metrics -> density bonus = 2.0 (capped at max)."""
        segment = SourceSegment(
            filing_id=1,
            segment_type="paragraph",
            raw_text="Sample text",
            candidate_metric_ids=[f"cm_metric_{i}" for i in range(10)],
            classifier_confidence=0.0,
        )
    ...
    def test_temporal_trend_adds_1_point(self, enricher: SegmentEnricher) -> None:
    ...
    def test_cohort_breakdown_adds_1_5_points(self, enricher: SegmentEnricher) -> None:
    ...
    def test_definition_flag_adds_1_point(self, enricher: SegmentEnricher) -> None:
    ...
    def test_all_flags_false_no_bonus(self, enricher: SegmentEnricher) -> None:
    ...
    def test_image_count_zero(self, enricher: SegmentEnricher) -> None:
    ...
    def test_image_count_one(self, enricher: SegmentEnricher) -> None:
    ...
    def test_image_count_three_capped(self, enricher: SegmentEnricher) -> None:
    ...
    def test_empty_segment_score_zero(self, enricher: SegmentEnricher) -> None:
    ...
    def test_typical_goldmine_segment(self, enricher: SegmentEnricher) -> None:
    ...
    def test_maximum_score_capped_at_ten(self, enricher: SegmentEnricher) -> None:
    ...
    def test_farfetch_like_segment(self, enricher: SegmentEnricher) -> None:
    ...
    def test_score_5_0_not_goldmine(self, enricher: SegmentEnricher) -> None:
    ...
    def test_score_5_5_exactly_is_goldmine(self, enricher: SegmentEnricher) -> None:
    ...
    def test_score_6_5_is_goldmine(self, enricher: SegmentEnricher) -> None:
    ...
    def test_score_9_5_is_goldmine(self, enricher: SegmentEnricher) -> None:
    ...
    def test_full_enrich_batch_sets_richness_score(self, enricher: SegmentEnricher) -> None:
    ...
    def test_all_inputs_at_minimum(self, enricher: SegmentEnricher) -> None:
    ...
    def test_floating_point_precision(self, enricher: SegmentEnricher) -> None:
...
class TestClusteringIntegration:
    ...
    def test_full_pipeline_enrich_then_cluster(self, enricher: SegmentEnricher) -> None:
    ...
    def test_no_goldmines_returns_empty_clusters(self, enricher: SegmentEnricher) -> None:
...
class TestSubscriberPatternDetection:
    ...
    def test_subscriber_keyword_millions(self, enricher: SegmentEnricher) -> None:
    ...
    def test_subscriber_base_growth(self, enricher: SegmentEnricher) -> None:
    ...
    def test_total_subscribers(self, enricher: SegmentEnricher) -> None:
    ...
    def test_subscriber_count_keyword(self, enricher: SegmentEnricher) -> None:
    ...
    def test_subscriber_with_count_millions(self, enricher: SegmentEnricher) -> None:
    ...
    def test_subscriber_with_count_abbreviation(self, enricher: SegmentEnricher) -> None:
    ...
    def test_subscription_not_matched(self, enricher: SegmentEnricher) -> None:
    ...
    def test_describe_not_matched(self, enricher: SegmentEnricher) -> None:
    ...
    def test_paid_subscribers_with_numeric(self, enricher: SegmentEnricher) -> None:
    ...
    def test_case_variations(self, enricher: SegmentEnricher) -> None:
...
class TestPlatformPatternDetection:
    ...
    def test_active_listings_plural(self, enricher: SegmentEnricher) -> None:
    ...
    def test_active_listing_singular(self, enricher: SegmentEnricher) -> None:
    ...
    def test_total_merchants_detection(self, enricher: SegmentEnricher) -> None:
    ...
    def test_active_sellers_detection(self, enricher: SegmentEnricher) -> None:
    ...
    def test_total_vendors_detection(self, enricher: SegmentEnricher) -> None:
    ...
    def test_platform_transactions_detection(self, enricher: SegmentEnricher) -> None:
    ...
    def test_marketplace_transactions_detection(self, enricher: SegmentEnricher) -> None:
    ...
    def test_gmv_per_merchant_detection(self, enricher: SegmentEnricher) -> None:
    ...
    def test_gmv_per_seller_detection(self, enricher: SegmentEnricher) -> None:
    ...
    def test_listing_alone_not_matched(self, enricher: SegmentEnricher) -> None:
    ...
    def test_merchant_account_not_matched(self, enricher: SegmentEnricher) -> None:
    ...
    def test_active_listings_with_count_millions(self, enricher: SegmentEnricher) -> None:
    ...
    def test_merchants_with_count(self, enricher: SegmentEnricher) -> None:
    ...
    def test_platform_engagement_detection(self, enricher: SegmentEnricher) -> None:
...
class TestRichnessScoreNaNInfValidation:
    ...
    def test_max_score_passes_through(self, enricher: SegmentEnricher) -> None:
...
class TestEngagementPatternDetection:
    ...
    def test_session_duration_detected(self, enricher: SegmentEnricher) -> None:
    ...
    def test_session_length_detected(self, enricher: SegmentEnricher) -> None:
    ...
    def test_average_session_duration_detected(self, enricher: SegmentEnricher) -> None:
    ...
    def test_sessions_per_user_detected(self, enricher: SegmentEnricher) -> None:
    ...
    def test_sessions_per_customer_detected(self, enricher: SegmentEnricher) -> None:
    ...
    def test_time_spent_detected(self, enricher: SegmentEnricher) -> None:
    ...
    def test_time_in_app_detected(self, enricher: SegmentEnricher) -> None:
    ...
    def test_engagement_rate_detected(self, enricher: SegmentEnricher) -> None:
    ...
    def test_engagement_score_detected(self, enricher: SegmentEnricher) -> None:
    ...
    def test_session_alone_not_detected(self, enricher: SegmentEnricher) -> None:
    ...
    def test_engaged_customers_not_detected(self, enricher: SegmentEnricher) -> None:
...
class TestConversionPatternDetection:
    ...
    def test_conversion_rate_detected(self, enricher: SegmentEnricher) -> None:
    ...
    def test_conversion_rate_case_insensitive(self, enricher: SegmentEnricher) -> None:
    ...
    def test_free_to_paid_hyphenated_detected(self, enricher: SegmentEnricher) -> None:
    ...
    def test_free_to_paid_spaced_detected(self, enricher: SegmentEnricher) -> None:
    ...
    def test_trial_conversion_detected(self, enricher: SegmentEnricher) -> None:
    ...
    def test_trial_conversion_rate_detected(self, enricher: SegmentEnricher) -> None:
    ...
    def test_paid_subscriber_conversion_detected(self, enricher: SegmentEnricher) -> None:
    ...
    def test_convert_verb_not_detected(self, enricher: SegmentEnricher) -> None:
    ...
    def test_conversion_without_rate_not_detected(self, enricher: SegmentEnricher) -> None:
...
class TestEngagementConversionRichnessScore:
    ...
    def test_engagement_keywords_add_half_point(self, enricher: SegmentEnricher) -> None:
    ...
    def test_conversion_keywords_add_half_point(self, enricher: SegmentEnricher) -> None:
    ...
    def test_both_engagement_and_conversion_stack(self, enricher: SegmentEnricher) -> None:
    ...
    def test_engagement_in_extra_metadata(self, enricher: SegmentEnricher) -> None:
    ...
    def test_conversion_in_extra_metadata(self, enricher: SegmentEnricher) -> None:
...
class TestTextCachingPerformance:
    ...
    def test_large_batch_enrichment_performance(self, enricher: SegmentEnricher) -> None:
    ...
    def test_text_caching_produces_consistent_results(self, enricher: SegmentEnricher) -> None:
